...
public class WordWidgetProvider extends AppWidgetProvider {
	...
	private static String ACTION_WIDGET_PREVIOUS = "org.forzaverita.brefdic.ACTION_WIDGET_PREVIOUS";
	private static String ACTION_WIDGET_NEXT = "org.forzaverita.brefdic.ACTION_WIDGET_NEXT";
	...
	private WidgetRefreshTask getRefreshTask(Context context) {
		if (service == null) {
			service = ((AppService) context.getApplicationContext());
		}
